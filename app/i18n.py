...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "ui.show_candidates": {"ko": "후보수", "en": "Candidates"},
    ...
    "net.b40": {"ko": "40블록 (최강·느림)", "en": "40-block (strongest, slow)"},
    "net.b28": {"ko": "28블록 (권장)", "en": "28-block (recommended)"},
    "net.b18": {"ko": "18블록 (빠름)", "en": "18-block (fast)"},
    "net.download_title": {"ko": "네트워크 다운로드", "en": "Download network"},
    "net.downloading": {"ko": "{name} 네트워크 다운로드 중…",
                        "en": "Downloading the {name} network…"},
    ...
    "estimate.not_ready": {"ko": "엔진 준비 후 사용하세요", "en": "Available once the engine is ready"},
    ...
    "dl.cancel": {"ko": "취소", "en": "Cancel"},
    "dl.cancelling": {"ko": "다운로드 취소 중…", "en": "Cancelling…"},
