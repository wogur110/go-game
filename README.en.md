...
- **Board aids:** **right-click to undo** (take back a move), hover **ghost stone** for the next move, hover a candidate (in the list **or on the board**) to preview its **variation (next 10 moves)**, plus **move-order** and **territory** toggles
